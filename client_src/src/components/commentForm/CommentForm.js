...
class CommentForm extends Component {
  ...
  onSubmitHandler(e) {
    ...
    if (typeof this.props.commentId === 'undefined') {
      // If no parent comments, then this is not a reply and we will paste it at the bottom of the page
    ...
    axios
      .post('http://localhost:3000/api/Containers/pics/upload', formData)
      .catch(err => {
        console.log(err);
      });
          ...
          <form className="myForm" onSubmit={this.onSubmitHandler.bind(this)}>
            ...
            <div className="file-field input-field">
              ...
              <div className="file-path-wrapper">
                <input
                  placeholder='Choose avatar in "jpg", "png" format'
                  required=""
                  style={{display: ''}}
            ...
            <input
              type="submit"
              value="Comment"
              className="btn col s12 m12 l3 right"
            />
          </form>
        </div>
      </div>
